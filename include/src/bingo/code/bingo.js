...
(function (upred) {
    ...
    (function (math) {
        ...
        var BingoGroup = (function () {
            function BingoGroup(canvas) {
                this.cellTexts = [];
                this.cellTextTags = [];
                this.cellColors = [];
                this.cellMarks = [];
            ...
            BingoGroup.prototype.MakeTable = function (colN, rowN) {
                ...
                rectTag.setAttribute('width', (this.cellSizeW * colN).toString());
                ...
                for (var i = 0; i <= colN; i++) {
                    ...
                    lineTag.setAttribute('stroke-width', '5');
                    lineTag.setAttribute('stroke-linecap', 'square');
                ...
                for (var i = 0; i <= rowN; i++) {
                    ...
                    lineTag.setAttribute('x2', (this.cellSizeW * colN).toString());
                ...
                for (var row = 0; row < rowN; row++) {
                    this.cellTextTags[row] = [];
                    this.cellColors[row] = [];
                    this.cellMarks[row] = [];
                    for (var col = 0; col < colN; col++) {
                        var ttag = upred.ui.SVGSymbol.MakeTextTag(this.cellSizeW * col + this.cellSizeW / 2, this.cellSize * row + this.cellSize * 0.48, this.cellTexts[row][col].toString(), 'black', 'black', '1', 'bold ' + (this.cellSize * 0.6) + 'px sans-serif', 'middle', 'central');
                        ttag.style.touchAction = 'none';
                        ttag.style.pointerEvents = 'none';
                        ttag.style.userSelect = 'none';
                        this.cellTextTags[row][col] = ttag;
                        this.textRootTag.appendChild(ttag);
                    }
                }
            };
            BingoGroup.prototype.InputCell = function (px, py) {
                ...
                fobj.setAttributeNS(null, "x", (col * this.cellSizeW).toString());
                fobj.setAttributeNS(null, "y", (row * this.cellSize).toString());
                fobj.setAttributeNS(null, "width", this.cellSizeW.toString());
                fobj.setAttributeNS(null, "height", this.cellSize.toString());
                this.groupTag.appendChild(fobj);
                ...
                txt.style.fontSize = (this.cellSize * 0.6).toString() + 'px';
                txt.style.textAlign = 'center';
                txt.value = this.cellTexts[row][col];
                fobj.appendChild(txt);
                var self = this;
                txt.onblur = function () {
                    self.cellTexts[row][col] = txt.value;
                    self.cellTextTags[row][col].textContent = self.cellTexts[row][col];
                    self.groupTag.removeChild(fobj);
                };
                window.setTimeout(function () {
                    txt.focus();
                }, 300);
            };
            BingoGroup.prototype.PaintCell = function (px, py) {
                var rootXY = this.svgCanvas.GetGroupPositionValue(this.groupTag);
                var x = px - rootXY.x;
                var y = py - rootXY.y;
                var col = Math.floor(x / this.cellSize);
                ...
                if (!this.cellColors[row][col]) {
                    ...
                    this.cellColors[row][col].setAttribute('x', (this.cellSizeW * col + 3).toString());
                    this.cellColors[row][col].setAttribute('y', (this.cellSize * row + 3).toString());
                    this.cellColors[row][col].setAttribute('width', (this.cellSizeW - 6).toString());
                    this.cellColors[row][col].setAttribute('height', (this.cellSize - 6).toString());
            ...
            BingoGroup.prototype.CheckCell = function (px, py) {
                var rootXY = this.svgCanvas.GetGroupPositionValue(this.groupTag);
                var x = px - rootXY.x;
                var y = py - rootXY.y;
                var col = Math.floor(x / this.cellSize);
                ...
                if (this.cellMarks[row][col]) {
                    ...
                    this.cellMarks[row][col].setAttribute('cx', (this.cellSizeW * col + this.cellSizeW / 2).toString());
                    ...
                    this.cellMarks[row][col].setAttribute('style', 'fill:none; stroke:red; stroke-width:4px; touch-action: none;');
                    this.cellMarks[row][col].style.pointerEvents = 'none';
                    this.marksBackTag.appendChild(this.cellMarks[row][col]);
                }
            };
            BingoGroup.prototype.CopyArray = function (target, source, tagParent) {
            ...
            BingoGroup.prototype.Duplicate = function () {
                var group = new BingoGroup(this.svgCanvas);
                ...
                group.MakeTable(this.cellTexts[0].length, this.cellTexts.length);
                ...
                this.CopyArray(group.cellTexts, this.cellTexts);
                for (var i = 0; i < group.cellTexts.length; i++) {
                    for (var j = 0; j < group.cellTexts[i].length; j++) {
                        group.cellTextTags[i][j].textContent = group.cellTexts[i][j];
                    }
                }
                return group;
            };
            BingoGroup.prototype.SetColor = function (r, g, b) {
                this.tableRootTag.firstChild.style.fill = this.MakeRGB(r, g, b, 1);
            };
            BingoGroup.prototype.MakeRGB = function (r, g, b, m) {
                r *= m;
                if (r < 0)
                    r = 0;
                if (r > 255)
        ...
        var Bingo = (function () {
            ...
            Bingo.prototype.MakeRGB = function (r, g, b, m) {
                r *= m;
                if (r < 0)
                    r = 0;
                if (r > 255)
            ...
            Bingo.prototype.HexToRGB = function (hex) {
                if (hex[0] == '#') {
            ...
            Bingo.prototype.ChangeColor = function (item, colrstr) {
                if (this.paintMode == 0) {
            ...
            Bingo.prototype.ChangeColorHandler = function (colorstr) {
                this.curSelectedColor = colorstr;
            };
            Bingo.prototype.MakePaletteButton = function (imgsrc) {
            ...
            Bingo.prototype.InitPalette = function () {
                this.svgCanvas = new upred.ui.SVGCanvas();
                this.paletteTag = document.getElementById('UI_PALETTE');
                var chart100bt = this.MakePaletteButton('./asset/icon_cell9.png');
                chart100bt.addEventListener('pointerdown', this.OnDragStartNew9.bind(this));
                var chartCustombt = this.MakePaletteButton('./asset/icon_cell16.png');
                chartCustombt.addEventListener('pointerdown', this.OnDragStartNew16.bind(this));
            ...
            Bingo.prototype.OnClickPaint = function () {
                if (this.paintMode != 1) {
                    this.paintMode = 1;
            ...
            Bingo.prototype.OnClickChecker = function () {
                if (this.paintMode != 2) {
                    this.paintMode = 2;
            ...
            Bingo.prototype.ResetWorkMode = function () {
                this.paintMode = 0;
                this.buttonPaint.className = 'paletteButtonClass';
                this.buttonChecker.className = 'paletteButtonClass';
            };
            Bingo.prototype.OnDragStartNew9 = function (e) {
                var _a;
                if (!e.currentTarget)
                    return;
                ...
                var tgroup = new BingoGroup(this.svgCanvas);
                tgroup.MakeTable(3, 3);
            ...
            Bingo.prototype.OnDragStartNew16 = function (e) {
                var _a;
                if (!e.currentTarget)
                    return;
                var xy = e.currentTarget.getBoundingClientRect();
            ...
            Bingo.prototype.OnDragStartMove = function (e) {
                var _a;
            ...
            Bingo.prototype.OnDragging = function (e) {
            ...
            Bingo.prototype.OnDragEnd = function (e) {
                var _a, _b, _c, _d;
                if (this.dragMode == DragMode.MOVE || this.dragMode == DragMode.NEW) {
                    var dx = this.xyNow.x - this.xyBefore.x;
                    var dy = this.xyNow.y - this.xyBefore.y;
                                ...
                                if (dx * dx + dy * dy < 32) {
                                    if (this.paintMode == 1) {
                                        ...
                                        if (upred.ui.uiModule.selectedItems.length > 0 &&
                                            upred.ui.uiModule.selectedItems[0] == tg &&
                                            this.dragMode == DragMode.MOVE) {
                                            tg.InputCell(e.pageX, e.pageY);
                                        }
                                        else {
            ...
            Bingo.prototype.AssignHandlersAndShow = function (group, x, y) {
            ...
            Bingo.prototype.ShowHighlighted = function (group, flag) {
                if (group) {
                    if (flag) {
            ...
            Bingo.prototype.SetSelectionBy = function (x, y, w, h) {
                var _a;
                for (var i = 0; i < this.charts.length; i++) {
            ...
            Bingo.prototype.Rotate = function (group, degree) {
            ...
            Bingo.prototype.Delete = function (targetGroup) {
            ...
            Bingo.prototype.Duplicate = function (targetGroup) {
                var _a, _b;
                if (targetGroup != null) {
            ...
            Bingo.prototype.RestoreInitialState = function () {
            ...
            Bingo.prototype.EnableInteraction = function () {
                this.svgCanvas.MoveToFront();
                this.svgCanvas.GetTag().setAttribute('style', 'position:absolute; left:0px; top:0px; z-index:750;');
            };
            Bingo.prototype.DisableInteraction = function () {
                this.svgCanvas.GetTag().setAttribute('style', 'position:absolute; left:0px; top:0px; z-index:400;');
            };
            Bingo.prototype.AdjustCellSize = function (cgroup, colCount, rowCount) {
                ...
                cgroup.cellSizeW = Math.min(w, h) * 1.2;
            };
