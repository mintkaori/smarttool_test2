...
class TransformControlsGizmo extends THREE.Object3D {
	constructor() {
		...
		matRed.color.setHex(0xffffff);
		matRed.opacity = 0;

		const matGreen = gizmoMaterial.clone();
		matGreen.color.setHex(0xffffff);
		matGreen.opacity = 0;

		const matBlue = gizmoMaterial.clone();
		matBlue.color.setHex(0xffffff);
		matBlue.opacity = 0;

		const matRedTransparent = gizmoMaterial.clone();
		matRedTransparent.color.setHex(0xffffff);
		matRedTransparent.opacity = 0;

		const matGreenTransparent = gizmoMaterial.clone();
		matGreenTransparent.color.setHex(0xffffff);
		matGreenTransparent.opacity =  0;

		const matBlueTransparent = gizmoMaterial.clone();
		matBlueTransparent.color.setHex(0xffffff);
		...
		matYellowTransparent.color.setHex(0xffffff);
		...
		const lineGeometry2 = new THREE.CylinderGeometry(
			0.0075,
			0.0075,
			0.5,
			3
