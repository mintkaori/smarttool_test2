    ...
    (function (math) {
        var Rod = (function () {
            function Rod(canvas) {
                ...
                this.rectTag = this.MakeTagStyled(this.groupTag, 'rect', { x: '0', y: '0' }, { strokeWidth: this.lineThickness.toString(), touchAction: 'none', pointerEvents: 'visiblePainted', userSelect: 'none' });
            }
            Rod.prototype.MakeRod = function (unitW, lengthCount) {
                this.unitW = unitW;
            ...
            Rod.prototype.Duplicate = function () {
                var pc = new Rod(this.svgCanvas);
                pc.unitW = this.unitW;
            ...
            Rod.prototype.SetColor = function (r, g, b) {
                this.colorValue.r = r;
                this.colorValue.g = g;
                this.colorValue.b = b;
            ...
            Rod.prototype.MakeRGB = function (r, g, b, m) {
                r *= m;
                if (r < 0)
                    r = 0;
                if (r > 255)
            ...
            Rod.prototype.MakeTagStyled = function (parent, tagname, attr, style) {
                var node = document.createElementNS('http://www.w3.org/2000/svg', tagname);
                for (var key in attr) {
                    if (attr.hasOwnProperty(key)) {
                        node.setAttribute(key, attr[key]);
            ...
            Rod.prototype.Highlight = function (flag) {
                if (flag) {
...
(function (upred) {
    ...
    (function (math) {
        ...
        var Rods = (function () {
            ...
            Rods.prototype.HexToRGB = function (hex) {
                if (hex[0] == '#') {
            ...
            Rods.prototype.ChangeColor = function (item, colrstr) {
                var color = this.HexToRGB(colrstr);
                if (item.SetColor) {
                    item.SetColor(color.r, color.g, color.b);
                }
            };
            Rods.prototype.OnDragStartNew = function (e) {
                var _a;
                if (!e.currentTarget)
                    return;
            ...
            Rods.prototype.OnDragStartMove = function (e) {
                var _a, _b;
                var usetag = e.target;
                if (!usetag)
                    return;
                if (this.dragMode == DragMode.NONE) {
                    ...
                    for (var i = 0; i < this.allObjs.length; i++) {
                        if (this.allObjs[i].type == 'rod' && this.allObjs[i].groupTag == usetag.parentNode) {
            ...
            Rods.prototype.OnDragging = function (e) {
                if (!this.curDragging)
                    return;
                var dx = e.pageX - this.xyBefore.x;
                var dy = e.pageY - this.xyBefore.y;
                if (this.curDragging.type != 'rod')
                    return;
            ...
            Rods.prototype.OnDragEnd = function (e) {
                var _a, _b;
                if (!this.curDragging)
                    return;
            ...
            Rods.prototype.AssignHandlerAndRegister = function (tline, x, y) {
            ...
            Rods.prototype.ShowHighlighted = function (group, flag) {
                if (group) {
                    if (group.Highlight)
                        group.Highlight(flag);
                }
            };
            Rods.prototype.SetSelectionBy = function (x, y, w, h) {
                var _a;
                for (var i = 0; i < this.allObjs.length; i++) {
            ...
            Rods.prototype.Rotate = function (group, degree) {
                var _a, _b, _c;
                if (group.type == 'rod') {
                    var pos = (_a = this.svgCanvas) === null || _a === void 0 ? void 0 : _a.GetGroupPositionValue(group.groupTag);
                    (_b = this.svgCanvas) === null || _b === void 0 ? void 0 : _b.SetGroupRotationValue(group.groupTag, pos.r + degree);
                    var pos2 = (_c = this.svgCanvas) === null || _c === void 0 ? void 0 : _c.GetGroupPositionValue(group.groupTag);
                    var near = this.curBoard.GetNearestPoint(pos2.x, pos2.y);
                    if (near) {
                        this.svgCanvas.SetGroupPositionValue(group.groupTag, near.x, near.y);
                    }
                }
            };
            Rods.prototype.Delete = function (targetGroup) {
            ...
            Rods.prototype.Duplicate = function (targetGroup) {
                var _a, _b;
            ...
            Rods.prototype.RestoreInitialState = function () {
            ...
            Rods.prototype.EnableInteraction = function () {
                this.svgCanvas.MoveToFront();
                this.svgCanvas.GetTag().setAttribute('style', 'position:absolute; left:0px; top:0px; z-index:750;');
            };
            Rods.prototype.DisableInteraction = function () {
                this.svgCanvas.GetTag().setAttribute('style', 'position:absolute; left:0px; top:0px; z-index:400;');
            };
            Rods.prototype.InitBoard = function () {
            ...
            Rods.prototype.DuplicationChecker = function () {
                if (upred.ui.uiModule.selectedItems.length <= 1) {
                    if (upred.ui.uiModule.selectedItems[0].type
                        && upred.ui.uiModule.selectedItems[0].type != 'board')
                        return true;
            ...
            Rods.prototype.InitPalette = function () {
                ...
                for (var i = 1; i <= 10; i++) {
                    var rodBase = new upred.ui.SVGUnit();
                    var tng = new math.Rod(this.svgCanvas);
                    tng.MakeRod(this.UNIT_SIZE, i);
                    tng.SetColor(colors[i * 3 - 3], colors[i * 3 + 1 - 3], colors[i * 3 + 2 - 3]);
                    tng.rectTag.addEventListener('pointerdown', this.OnDragStartNew.bind(this));
                    rodBase.GetTag().appendChild(tng.groupTag);
                    rodBase.GetTag().style.display = 'inline-block';
                    rodBase.GetTag().style.margin = '8px 8px';
                    rodBase.SetViewBox(-2, 0, this.UNIT_SIZE * 10, this.UNIT_SIZE);
                    rodBase.SetSize((this.UNIT_SIZE * (10)) / 2, this.UNIT_SIZE / 2);
                    this.paletteTag.appendChild(rodBase.GetTag());
                }
